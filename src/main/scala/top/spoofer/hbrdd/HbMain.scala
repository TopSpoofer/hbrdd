...
object HbMain {
  ...
  private val data = "hdfs://localhost:9000/test/hbase/testhb"
  ...
  private def testRdd2HbaseTs() = {
    ...
    val sparkConf = new SparkConf()
      ...
      .setAppName(appName).setJars(List("/home/spoofer/coding/hbrdd/out/artifacts/hbrdd_jar/hbrdd.jar"))
  ...
  private def testReadHbase() = {
    ...
    implicit val hbConfig = HbRddConfig()
    val savePath = "hdfs://localhost:9000/test/spark/hbase/calculation_result"
  ...
  private def testdeleteHbase1() = {
    ...
    val sparkConf = new SparkConf()
      .setMaster(s"spark://$master:$port").set("executor-memory", "1g")
      .setAppName(appName).setJars(List("/home/spoofer/coding/hbrdd/out/artifacts/hbrdd_jar/hbrdd.jar"))
    val sc = new SparkContext(sparkConf)
